...
fun NewsCard(article: ArticleEntity, onClick: () -> Unit, sourceName: String) {
    val context = LocalContext.current
    // Read the selective text scale provided by the theme; default 1.0f
    val textScale = com.museovirtualnacional.strogoff.ui.theme.LocalTextScale.current
    Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Text(
                    ...
                    style = MaterialTheme.typography.titleLarge.copy(
                        ...
                        lineHeight = MaterialTheme.typography.titleLarge.lineHeight * textScale
                    ),
                    maxLines = 2,
